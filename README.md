...
Para cada hipótese, foram gerados gráficos a partir dos resultados das consultas Spark SQL, incluindo:
...
- `MVP_EngDados.ipynb` – Notebook principal com todo o pipeline, análises e diagramas
